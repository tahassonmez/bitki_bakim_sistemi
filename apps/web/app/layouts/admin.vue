<template>
  <div class="min-h-screen bg-[#f7f8f4]">
    <aside class="fixed inset-y-0 left-0 hidden w-64 flex-col border-r border-[#dfe5dc] bg-[#203d30] px-5 py-6 text-white lg:flex">
      <NuxtLink to="/dashboard" class="mb-8 flex items-center gap-3">
        <img src="/jungleous-logo.png" alt="Jungleous" class="h-9 w-auto shrink-0 rounded-xl bg-white p-1" />
        <small class="text-xs text-[#b8cdbb]">Bitki bakım merkezi</small>
      </NuxtLink>
      <nav class="space-y-2 text-sm">
        <a href="/dashboard" class="flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-[#d7e6d8] transition hover:bg-white/10">◈ <span>Genel bakış</span></a>
        <a href="/customers" class="flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-[#d7e6d8] transition hover:bg-white/10">⌂ <span>Müşteriler</span></a>
        <a href="/plants" class="flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-[#d7e6d8] transition hover:bg-white/10">◌ <span>Bitki envanteri</span></a>
        <a href="/maintenance-logs" class="flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-[#d7e6d8] transition hover:bg-white/10">✓ <span>Bakım kayıtları ve bakımlar</span></a>
        <a href="/staff" class="flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-[#d7e6d8] transition hover:bg-white/10">◎ <span>Personel</span></a>
        <a href="/chat" class="flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-[#d7e6d8] transition hover:bg-white/10">
      ...
      <div class="mt-auto rounded-2xl border border-white/10 bg-white/5 p-3.5">
    ...
    <Transition name="admin-mobile-slide">
      <aside
        v-if="mobileMenuOpen"
        class="fixed inset-y-0 left-0 z-50 flex w-64 flex-col bg-[#203d30] px-5 py-6 text-white lg:hidden"
      >
    ...
    <main class="min-h-screen lg:pl-64">
      <header class="flex items-center justify-between border-b border-[#dfe5dc] bg-[#f7f8f4]/90 px-4 py-3.5 backdrop-blur lg:px-8">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 class="display mt-1 text-lg font-semibold">Bitki bakım merkezi</h1>
          </div>
        </div>
        <div class="flex items-center gap-3">
